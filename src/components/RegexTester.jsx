...
const RegexTester = () => {
  ...
  return (
    <div className="container mt-4">
      ...
      <div className="mb-3">
        <label style={{ marginRight: "20px" }} className="form-label">
          Flags:
        </label>
            ...
            <div className="modal-content">
              ...
              <div className="modal-body">
                ...
                <ul>
                  ...
                  <li>
                    <code>a+</code> — 1 or more a's
                  </li>
                  <li>
                    <code>a?</code> — 0 or 1 a
                  </li>
                  <li>
                ...
                <ul>
                  <li>
                    <code>g</code> — Global search (find all matches, not just
                    the first)
                  </li>
                  <li>
                  ...
                  <li>
                    <code>m</code> — Multi-line mode (<code>^</code> and{" "}
                    <code>$</code> match start/end of lines)
                  </li>
                  <li>
                    <code>s</code> — Allows <code>.</code> to match newline
                    characters
                  </li>
                  <li>
                    <code>u</code> — Treat pattern as a sequence of Unicode code
                    points
                  </li>
                  <li>
                    <code>y</code> — Sticky matching (matches starting at the
