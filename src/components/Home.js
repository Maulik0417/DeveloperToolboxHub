        ...
        <div className="col-md-6 col-lg-4 mb-4">
          <div className="card shadow-sm h-100">
            <div className="card-body d-flex flex-column">
              ...
              <p className="card-text text-muted">Test HTTP requests with custom headers, body data, and more.</p>
              <Link to="/api-tester" className="btn btn-primary mt-auto">Launch</Link>
            </div>
          </div>
        </div>
        ...
        <div className="col-md-6 col-lg-4 mb-4">
          <div className="card shadow-sm h-100">
            <div className="card-body d-flex flex-column">
              ...
              <Link to="/regex-tester" className="btn btn-primary mt-auto">Launch</Link>
            </div>
          </div>
        </div>
        ...
        <div className="col-md-6 col-lg-4 mb-4">
          <div className="card shadow-sm h-100">
            <div className="card-body d-flex flex-column">
              ...
              <p className="card-text text-muted">New utilities will appear here as they’re built.</p>
